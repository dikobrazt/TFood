...
extension UIColor {
    ...
    internal static func accentColor(withOpacity alpha:  CGFloat) -> UIColor? {
        return UIColor(red: 253.0/255.0, green: 58.0/255.0, blue: 105.0/255.0, alpha: alpha)
    }
    
    internal static func mainTextColor(withOpacity alpha:  CGFloat) -> UIColor? {
        return UIColor(red: 157.0/255.0, green: 162.0/255.0, blue: 175.0/255.0, alpha: alpha)
    }
    
    internal static func inActiveColor(withOpacity alpha:  CGFloat) -> UIColor? {
        return UIColor(red: 195.0/255.0, green: 196.0/255.0, blue: 201.0/255.0, alpha: alpha)
    }
    
    internal static func secondaryTextColor(withOpacity alpha:  CGFloat) -> UIColor? {
        return UIColor(red: 170.0/255.0, green: 170.0/255.0, blue: 173.0/255.0, alpha: alpha)
    }
    
    internal static func grayBackgroundColor(withOpacity alpha:  CGFloat) -> UIColor? {
